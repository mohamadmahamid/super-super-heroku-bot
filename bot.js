...
client.login('NDAxNjA2Mjg4Mjk2OTAyNjY3.DTsohA.KZUXWowy0hZi04StrSQHvuruRrk'); 
...
client.user.setGame(` Real Bros Server ! `,"http://twitch.tv/DEMON")
client.user.setStatus("dnd")
});
...
var prefix = "#";
  ...
  var args = message.content.split(' ').slice(1);
  var argresult = args.join(' ');
  if (!message.author.id === '402489708078432287') return;
...
if (message.content.startsWith(prefix + 'streaming')) {
  client.user.setGame(argresult, "https://www.twitch.tv/pgbot");
    message.channel.sendMessage(`**${argresult}** :تم تغيير الستريمنج بنجاح`)
} else
...
/*----------------------------------------------------------------------------------------*/
 ...
 const cuttweet = [
     ...
     '‏كت تويت | عمرك ش��ت مصيبة عن شخص برغبتك ؟',
...
const fkk = [
 ...
 client.on('message', message => {
  ...
  .setColor('RANDOM')
   ...
   .setThumbnail(message.author.avatarURL) 
 .addField('لعبه فكك' ,
  `${fkk[Math.floor(Math.random() * fkk.length)]}`)
  message.channel.sendEmbed(embed);
  console.log('[id] Send By: ' + message.author.username)
  if(message.content === "#"){
message.reply(" +1");
...
client.login('NDAyNDg5NzA4MDc4NDMyMjg3.DT5l3w.paV5NdmJyqJe0pfy-OxLf3jGPd4'); 
...
var client = new Eris("NDAxNjA2Mjg4Mjk2OTAyNjY3.DTsohA.KZUXWowy0hZi04StrSQHvuruRrk");
var chaneel_id = "402920606183718923";
                    var i = "0";
                    var x = "0";
client.on("voiceChannelJoin", (msg) => {
    x++;
    client.editChannel(chaneel_id, { name : "Real Bros Voice ( "+x+" ) ..!"});
});
...
client.on("messageCreate", (msg) => {
    if(msg.author.id !== "224002740647493632") return client.createMessage('__**This Command is only for the bot Owner**__');
    ...
    console.log(x);
    client.createMessage(msg.channel.id, "الاعضاء الذين في الرومات : **"+x+"**!");
    client.editChannel(chaneel_id, { name : "Real Bros Voice ( "+x+" ) ..!"});
    messages = [];
}, 1);
    }
...
client.connect("NDAxNjA2Mjg4Mjk2OTAyNjY3.DTsohA.KZUXWowy0hZi04StrSQHvuruRrk")
...
var prefix = ".";
  ...
  var args = message.content.split(' ').slice(1);
  var argresult = args.join(' ');
  if (!message.author.id === '403558521569935362') return;
...
client.on("message", message => {
    var tot = [
    "https://cdn.discordapp.com/attachments/384691354468614155/403560630717644801/colors.png",    
    "https://cdn.discordapp.com/attachments/384691354468614155/403560661499510784/colors.png"
    ];
if (message.content === "الوان") {
    const embed = new Discord.RichEmbed()
    .setColor("RANDOM")
    .setImage(`${tot[Math.floor(Math.random() * tot.length)]}`);
    message.channel.sendEmbed(embed);
    message.react("👍");
return;
}
...
client.on('message', msg => {
  if (msg.content === 'الوان') {
    msg.reply('**لتغيير لونك اكتب لون (والرقم) مثال : لون 1 **');
  }
});
...
client.login('NDAzNTU4NTIxNTY5OTM1MzYy.DUJCrw.JWQZfVGAttjWevYmny8v--Zz8PQ');
...
/*----------------------------------------------------------------------------------------*/
      ...
      client.on('ready', () => {
        client.user.setGame(`Real Bros Server ! `,'https://www.twitch.tv/TBroadcast');
...
var bc = new Discord.RichEmbed()
          ...
          .setTitle('اضغط هنا للدخول الى السيرفر')
          .setURL('https://discord.gg/NgS8Cgs')
          .addField('⁕ من سـيرفر', `${message.guild.name}`,true)
          .addField('⁕ الـمرسل ', `${message.author.username}#${message.author.discriminator}`,true)
          .addField(':mailbox_with_mail: الرسالة ', args)
...
var prefix = "&";
  ...
  var args = message.content.split(' ').slice(1);
  var argresult = args.join(' ');
  if (!message.author.id === '402381303938285590') return;
...
/*----------------------------------------------------------------------------------------*/
client.login("NDAyMzgxMzAzOTM4Mjg1NTkw.DT_fGg.xJkFUhz3ci57JEJDcfL60NmiUq4")
/*----------------------------------------------------------------------------------------*/
...
var prefix = "*";
  ...
  var args = message.content.split(' ').slice(1);
  var argresult = args.join(' ');
  if (!message.author.id === '402382418440617985') return;
...
client.login("NDAyMzgyNDE4NDQwNjE3OTg1.DT37lw.0hkGMyvwq59Y9Rk7_P5EwWKfL_Y")
...
client.on('message', message => {
    ...
    if (message.content === "W") {
        ...
        message.edit('**✱↬ WELCOME TO R**')
        message.edit('**✱↬ WELCOME TO RE**')
        message.edit('**✱↬ WELCOME TO REA**')
        message.edit('**✱↬ WELCOME TO REAL**')    
        message.edit('**✱↬ WELCOME TO REAL **')    
        message.edit('**✱↬ WELCOME TO REAL B**')    
        message.edit('**✱↬ WELCOME TO REAL BR**')    
        message.edit('**✱↬ WELCOME TO REAL BRO**')    
        message.edit('**✱↬ WELCOME TO REAL BROS**')    
        message.edit('**✱↬ WELCOME TO REAL BROS S**')    
        message.edit('**✱↬ WELCOME TO REAL BROS SE**')    
        message.edit('**✱↬ WELCOME TO REAL BROS SER**')    
        message.edit('**✱↬ WELCOME TO REAL BROS SERV**')
        message.edit('**✱↬ WELCOME TO REAL BROS SERVE**')    
        message.edit('**✱↬ WELCOME TO REAL BROS SERVER**')   
        message.edit('**✱↬ WELCOME TO REAL BROS SERVER.↫✱**')
        message.edit('**✱↬ WELCOME TO REAL BROS SERVER..↫✱**')
        }, 50)
    }
...
var prefix = "!";
  ...
  var args = message.content.split(' ').slice(1);
  var argresult = args.join(' ');
  if (!message.author.id === '401779350522953728') return;
    ...
    message.channel.sendMessage(`**${argresult}** : تم تغيير صورة البوت بنجاح ✔`);
         ...
         client.on('message', message => {
            if (message.content === '!1') {
                message.delete()
              message.channel.send('**"WELCOME TO REAL BROS SERVER :cherry_blossom::dove:".**');
            }
});
         ...
         client.on('message', message => {
            if (message.content === '!2') {
                message.delete()
              message.channel.send('``• "WELCOME TO REAL BROS 🕊". •``');
            }
});
...
let embed = new Discord.RichEmbed()
    ...
    .addField('حالتك',`**[ ${member.user.presence.status.toUpperCase()} ]**`,true)
    .addField('تاريخ دخولك الدسكورد ','**[ '+member.user.createdAt.toLocaleString()+' ]**',true)

  channel.send(`"**Welcome To Real Bros Server**:cherry_blossom::dove:".`)
  channel.send({embed:embed});
});
...
client.login('NDAxNzc5MzUwNTIyOTUzNzI4.DT_fKw.hCTH4uhHXf7bhJ_9MeMBa4Zc0W0');
